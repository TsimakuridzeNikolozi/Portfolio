    ...
    <div className="flex items-start gap-x-2 sm:items-center md:gap-x-6">
      ...
      <div className="min-w-0 flex-1">
        ...
        <a href={workExperience.url} target="_blank" rel="noopener noreferrer">
          <span className="work-experience-company link-hover flex w-fit items-center gap-1 text-base text-accent/80 md:mb-2 md:text-lg md:font-medium 3xl:mb-3 3xl:text-2xl">
